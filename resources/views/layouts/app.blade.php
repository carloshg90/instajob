...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="/" style="color:#777"><img style=" heigth: 100px; width: 100px" src="http://127.0.0.1:8000/recursos/logo.png" alt="Logo" class="img-responsive"></a>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="http://localhost:8000/canviarContrassenya" class="btn btn-danger">Canviar contrassenya</a>
