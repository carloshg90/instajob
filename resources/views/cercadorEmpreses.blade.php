            ...
            console.log(empreses)
              if(keys.length == 0){
                ...
                for (var i = 0, len = keys.length; i < len; i++) {
                    ...
                    div.setAttribute("class",empreses[keys[i]].id);
                    principal.appendChild(div);
                    //Generar nom del treballador
                    var a = document.createElement('a');
                    var h3 = document.createElement('h3');
                    var linkText = document.createTextNode(empreses[keys[i]].name);
                    var idEmpresa = empreses[keys[i]].idEmpresa;
                    h3.appendChild(linkText);
                    a.setAttribute("href","/perfilAlie/"+empreses[keys[i]].id);
                    a.appendChild(h3);
                    div.appendChild(a);
                    ...
                    var zonah5 = document.createTextNode(empreses[keys[i]].zona);
                    ...
                    var horarih5 = document.createTextNode(empreses[keys[i]].horari);
                    ...
                    var sectorh5 = document.createTextNode(empreses[keys[i]].sector);
                    ...
                    var detallsh5 = document.createTextNode(empreses[keys[i]].email);
                    ...
                    btnContactar.setAttribute("class","btn btn-primary "+empreses[keys[i]].id+" ");
                    btnContactar.setAttribute("href","formulariContacte/"+empreses[keys[i]].id);
